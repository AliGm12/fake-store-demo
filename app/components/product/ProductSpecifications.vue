<template>
  ...
  >
    <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100">مشخصات فنی</h2>
    ...
    <div class="flex flex-col gap-3">
      ...
      >
        <div
          class="sm:w-28 sm:shrink-0 bg-[#F5F7FA] dark:bg-gray-800 rounded-2xl sm:rounded-l-sm sm:rounded-r-none px-4 py-3.5 text-sm text-[#57728E] dark:text-gray-400 flex items-center"
        >
          {{ row.label }}
        </div>

        <div
          class="flex-1 bg-[#F5F7FA] dark:bg-gray-800 rounded-2xl sm:rounded-r-sm sm:rounded-l-none px-4 py-3.5 text-[13px] text-[#30445B] dark:text-gray-300"
        >
          <ul
